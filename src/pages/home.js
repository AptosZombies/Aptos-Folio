  ...
  return (
    ...
    <div class="container-fluid">
      ...
      <div className="row container m-auto">
        <div className="col-12" style={{ marginTop: "20px", minHeight: "88vh" }}>
          {
            <div>
              <div className="row text-white mb-4" style={{ marginTop: "20px" }}>
              ...
              <section class="tiles">
                <article class="m-auto row mb-4 style1">
                  <span class="image">
                    <img src="https://global.discourse-cdn.com/aptoslabs/original/2X/3/3267a2098994f705ebb03bee5114d258be2182ee.png" alt=""></img>
                  </span>
                  <a href="https://aptos-folio.vercel.app/">
                      <h2>Aptos Folio</h2>
                      <div class="content" bis_skin_checked="1">
                          <p>Click and Connect NFT Portfolio.</p>
                      </div>
                  </a>
                </article>
              </section>
